...
var initialCafes = [{
    ...
    {
        name: "SKY",
        address: "Kärntner Str. 19, 1010 Wien",
        url: "http://www.skybox.at/",
        lat: 48.206403,
        lng: 16.371678,
        icon: "img/ic_local_cafe_white_24px.svg"
    },
    {
        name: "Café Korb",
        address: "Brandstätte 7-9, 1010 Wien",
        url: "http://www.cafekorb.at/",
        lat: 48.209793,
        lng: 16.371178,
        icon: "img/ic_local_cafe_white_24px.svg"
    },
    ...
    },
    {
        ...
        url: "https://www.cafebarbloom.at/default.html",
        lat: 48.210268,
        lng: 16.374127,
        icon: "img/ic_local_cafe_white_24px.svg"
    },
    ...
    {
        name: "Cafe Rüdigerhof",
        address: "Hamburgerstraße 20, 1050 Wien",
        url: "http://www.go5.at/index.php?i=go5user&u=40",
        lat: 48.195371,
        lng: 16.355232,
        icon: "img/ic_local_cafe_white_24px.svg"
    },
...
var Cafe = function(initialCafes) {
    ...
    this.address = initialCafes.address;
...
/*
function myFunction() {
  document.getElementById("cafe-list").classList.toggle("show");
}
